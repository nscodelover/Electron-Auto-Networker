...
var table_user_account = new PouchDB('table_user_account');
...
var action_style = ['None', 'Visit Profile', 'Send Message', 'Send Connection Request', 'Send Recommendation Request', 'Add Tag', 'Transfer to a New Campaign', 'Accept Connection Request'];
var action_title = ['none', 'visitProfile', 'sendMessage', 'sendConnectionRequest', 'sendRecomRequest', 'addTag', 'transferCampaign', 'acceptConnectionRequest'];
